...
class KinematicComputations:
    ...
    def compute_W_vertices_pos(self) -> List:
        ...
        base_H_r_foot = self.kindyn.get_relative_transform(ref_frame_name="root_link",
                                                           frame_name=self.feet_frames["right_foot"])
        W_H_RF = world_H_base.dot(base_H_r_foot)
        ...
        base_H_l_foot = self.kindyn.get_relative_transform(ref_frame_name="root_link",
                                                           frame_name=self.feet_frames["left_foot"])
        W_H_LF = world_H_base.dot(base_H_l_foot)
...
class Plotter:
    ...
    @staticmethod
    def plot_new_footstep(feet_frames: Dict, figure_footsteps: int, support_foot: str, new_footstep: Dict) -> None:
        ...
        colors = {feet_frames["left_foot"]: 'b', feet_frames["right_foot"]: 'r'}
...
class TrajectoryGenerator:
    ...
    def apply_joint_positions_and_base_orientation(self, denormalized_current_output: List,
                                                   base_pitch_offset: float = 0) -> (List, List):
